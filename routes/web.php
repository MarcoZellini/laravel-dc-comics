...
Route::put('/admin/comics/{comic}/trash', [ComicController::class, 'restore'])->name('restoreTrash');
Route::delete('/admin/comics/{comic}/trash', [ComicController::class, 'forceDestroy'])->name('deleteTrash');
